...
const JWT_SECRET = process.env.JWT_SECRET || 'YOUR_REALLY_STRONG_SECRET_KEY_HERE'; // Load from .env!
...
const authenticateToken = (req, res, next) => {
    ...
    jwt.verify(token, JWT_SECRET, (err, decoded) => {
        ...
        console.log(`[VerifyToken] Token valid for user ID: ${req.user.userId}, Email: ${req.user.email}`);
        next();
    });
};
